...
export class Pic {
  ...
  _toggleTitle() {
    this._picTitle = this._element.querySelector('.pic__name');
    if (this._picTitle.classList.contains('pic__name_visible')) {
      this._picTitle.classList.remove('pic__name_visible');
      this._picTitle.textContent = '';
    } else {
      this._picTitle.classList.add('pic__name_visible');
