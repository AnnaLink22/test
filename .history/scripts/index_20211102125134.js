...
const btn = document.getElementById('chosen-btn');
...
const addUsersSection = () => {
  const usersSectionElement = usersSection.generateSection();
  mainContainer.append(usersSectionElement);
}

const addChosenSection = () => {
  const chosenSectionElement = chosenSection.generateSection();
  mainContainer.append(chosenSectionElement);
}
