...
const tooltipEmpty = new Tooltip('tooltip__pic_type_empty', 'Список избранного пуст', 'Добавляйте изображения, нажимая на звездочки');
// const tooltipError = new Tooltip('.content', '.tooltip__pic_type_error', '')
const tooltipLoader = new Tooltip('')
